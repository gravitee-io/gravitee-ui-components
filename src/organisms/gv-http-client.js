...
import debugFormSchemaDef from './gv-http-client-schema-form.json';
    ...
    return html` <div class="container">
      <div class="request">
        ...
        <div class="request-form">
          <gv-schema-form .schema="${debugFormSchemaDef}" id="request-form" @gv-schema-form:change="${this._updateRequest}">
          </gv-schema-form>
          <gv-button
