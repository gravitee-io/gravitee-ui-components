...
storiesOf('Components.Atoms', module)
  .add('<gv-button>', () => withActions(...eventNames)(() => {
    ...
    return `
      ...
      <gv-button icon="cooking:dish" style="--gv-icon:white">${label || 'Default'}</gv-button>
      ...
      <gv-button default outlined disabled>${label || 'Default outlined & disabled'}</gv-button>
       <gv-button icon="cooking:dish" style="--gv-icon:white"></gv-button>
      ...
      <gv-button primary disabled icon="cooking:dish" style="--gv-icon:orange">${label || 'Primary disabled'}</gv-button>
      ...
      <gv-button primary disabled icon="cooking:dish" style="--gv-icon:orange"></gv-button>
      ...
      <gv-button skeleton primary disabled icon="cooking:dish" style="--gv-icon:orange"></gv-button>
      
      <div class="title">Sign In</div>
      <gv-button icon="thirdparty:github" outlined style="--gv-button: var(--github-color); --gv-icon: var(--github-color);">Sign in with GitHub</gv-button>
      <gv-button icon="thirdparty:github" style="--gv-button: var(--github-color);--gv-icon: #fff;">Sign in with GitHub</gv-button>
      ...
      <gv-button icon="thirdparty:oidc" style="--gv-button: var(--oidc-color);--gv-icon: #fff;">Sign in with OIDC</gv-button>
      
      <gv-button icon="thirdparty:gravitee" outlined style="--gv-button: var(--gv-logo-grey);">Sign in with Gravitee.io AM</gv-button>
      <gv-button icon="thirdparty:gravitee" style="--gv-button: var(--gv-logo-blue);--gv-icon: var(--gv-logo-white);">Sign in with Gravitee.io AM</gv-button>
    `;
  }), { notes });
