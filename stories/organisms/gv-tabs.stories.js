...
export const Simple = makeStory(conf, {
  items: [{
    ...
    value: 'one',
    innerHTML: '<div slot="content" id="tab-1">Content One</div>'
...
export const WithTitle = makeStory(conf, {
  items: [{
    options: [{ id: 'one', title: 'Tab 1' }, { id: 'two', title: 'Tab 2' }, { id: 'three', title: 'Tab 3' }],
    value: 'one',
    innerHTML: '<div slot="content" id="one">Content One</div>'
...
export const WithValidator = makeStory(conf, {
  items: [{
    ...
    value: 'two',
    innerHTML: '<div slot="content" id="one">You can open tab <b>two</b> or <b>three</b></div>'
